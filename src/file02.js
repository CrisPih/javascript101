...
for (let i= 0; i< frameworks.length;i++){
  ...
  let [nombre, fecha, nusuario, porcentaje ]= frameworks[i].split("|")

  var frameworkObj = {
    frameworkName: nombre.trim(),
    releaseDate: fecha.trim(),
    usersName: nusuario.trim(),
    popularityPercentage: porcentaje.trim(),
  }
